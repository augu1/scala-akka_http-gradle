  ...
  FileInput.prototype = {
    ...
    _ajaxSubmit: function (fnBefore, fnSuccess, fnComplete, fnError, previewId, index) {
      ...
      settings = $.extend(true, {}, {
        ...
        headers: NgaHeader,
        type: 'PUT',
        data: metadata + self.reader.result,
        // data: self.formdata,
        cache: false,
        processData: false,
    ...
    upload: function () {
      ...
      if (self.uploadAsync) {
        ...
        if (len < 2) {
          alert("Please upload Metadata and Document (2 separate files, metadata first)");
        } else {
          for (i = 0; i < len; i++) {
            if (i == 1 && self.filestack[i]) {
